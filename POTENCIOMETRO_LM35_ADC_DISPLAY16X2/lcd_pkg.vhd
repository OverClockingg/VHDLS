...
package lcd_pkg is
    ...
    -- Mensaje para posición central (ID: 1000)
    constant MSG_STANDBY : lcd_string := (ESP,ESP,ESP,S,I,S,T,E,M,A,ESP,E,N,ESP,ESP,ESP,
                                          ESP,ESP,ESP,E,S,P,E,R,A,DOSP,ESP,ESP,ESP,ESP,ESP,ESP);
    ...
    -- En lugar de usar str_to_lcd, usa los identificadores del diccionario:
	 ...
	 constant MSG_POT : lcd_string := (A,N,G,U,L,O,DOSP,ESP,ESP,ESP,ESP,ESP,ESP,ESP,ESP,ESP, others => ESP);
    ----------------------------------------------------------------------------
...
package body lcd_pkg is
    ...
    begin
        ...
        case id is
            ...
            when "1000" => return MSG_STANDBY(idx);
    ...
    begin
        case id is
            ...
            when "0101" => return 16; -- "ANGULO: XXX °"
            when "0010" => return 12;
            when "0011" => return 19;
            when "0110" => return 7;
            when "0111" => return 7;
